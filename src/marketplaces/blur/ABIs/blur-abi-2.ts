export type BlurExchange2ABIEvents = 'OwnershipTransferred';

export type BlurExcahnge2ABIMethodNames =
  | 'GOV'
  | 'addAffiliate'
  | 'addSponsoredMarket'
  | 'affiliates'
...
export const blurMarketplace2ABI = [
  {
    inputs: [
      { internalType: 'address', name: '_marketRegistry', type: 'address' },
  ...
  },
  {
    inputs: [
      {
        components: [
          { internalType: 'address[]', name: 'tokenAddrs', type: 'address[]' },
      ...
      {
        components: [
          { internalType: 'bytes', name: 'conversionData', type: 'bytes' },
        ],
  ...
  },
  {
    ...
    name: 'marketRegistry',
    outputs: [
      { internalType: 'contract MarketRegistry', name: '', type: 'address' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      ...
      { internalType: 'address[]', name: 'dustTokens', type: 'address[]' },
      { internalType: 'uint256[2]', name: 'feeDetails', type: 'uint256[2]' },
    ],
    name: 'multiAssetSwap',
    outputs: [],
    stateMutability: 'payable',
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_baseFees', type: 'uint256' }],
    name: 'setBaseFees',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'address', name: '_converter', type: 'address' }],
    name: 'setConverter',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      { internalType: 'bool', name: '_openForFreeTrades', type: 'bool' },
    ],
  ...
  {
    inputs: [{ internalType: 'bool', name: '_openForTrades', type: 'bool' }],
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_affiliateIndex', type: 'uint256' },
